package com.patrigod.patrigod.email.controller;

import com.patrigod.patrigod.email.entity.dto.input.UpdateMessageRequestDTO;
import com.patrigod.patrigod.email.service.ServiEmail;
