package com.patrigod.rating.infraestructure.repository.impl;
...
import com.patrigod.rating.infraestructure.repository.jpa.RatingRepositoryJpa;
...
public class CreateRatingRepositoryImpl implements CreateRatingRepository {
    ...
    public Rating createRating(Rating rating) {
        ...
        Optional<RatingJpa> exist = ratingRepositoryJpa.findByUsuarioIdAndArticle(userId, articleId);
